...
// 		}
	...
	if(((BTN_PIN & (1 << incr)) == 0) && (set == true) && (SW_time_date==0)){ 
	...
	if(((BTN_PIN & (1 << incr)) == 0) && set == true && SW_time_date==1){
		while(((BTN_PIN & (1 << incr)) == 0)){
			// while den khi tha nut nhan ra
		}
		if(count == 1) {
	...
	if(((BTN_PIN & (1 << incr)) == 0) && (set == true) && (SW_time_date==3)){
